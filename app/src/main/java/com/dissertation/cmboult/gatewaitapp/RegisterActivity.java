...
public class RegisterActivity extends FragmentActivity implements OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        hasRegistered = (ImageView) findViewById(R.id.not_registered);
        ((TextView) findViewById(R.id.gcm_userid_textview)).setText(regid);

        if(TextUtils.isEmpty(regid)){
            hasRegistered.setImageResource(R.drawable.ic_red_cross);
        }
        else{
            hasRegistered.setImageResource(R.drawable.ic_green_tick);
        }
